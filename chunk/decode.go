...
// The Encoding passed defines how the block storages of the SubChunk are decoded.
func DecodeSubChunk(buf *bytes.Buffer, c *Chunk, index *byte, e Encoding, upgradeType int) (*SubChunk, error) {
